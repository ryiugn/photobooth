...
# Import middleware
from middleware.cron_auth import CronAuthMiddleware
...
# Add cron authentication middleware
...
from routes import auth, frames, templates, camera, composition, users, activity, admin, frames_upload

app.include_router(auth.router, prefix="/api/v1/auth", tags=["Authentication"])
app.include_router(users.router, prefix="/api/v1/users", tags=["Users"])
app.include_router(activity.router, prefix="/api/v1/activity", tags=["Activity"])
app.include_router(frames.router, prefix="/api/v1/frames", tags=["Frames"])
app.include_router(frames_upload.router, prefix="/api/v1/frames", tags=["Frame Uploads"])
